...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="/events/update/{{$event->id}}" method="POST" enctype="multipart/form-data">
        <!-- se voce não colocar a diretiva "csrf" ele não deixa enviar o formulário, pois ela é uma maneira de garantir segurança a ataques de form -->
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <!-- items[] é uma sintaxe para criar um array desse tipo -->
